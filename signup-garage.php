...
if( $oname !='' and $email !='' and $phoneno !='' and $password !='' and $gname !='' and $address !='' )
{
	$check = mysqli_query($db,"SELECT * FROM register_garage where email = '$email'"); 
	...
	$sql="INSERT INTO register_garage(oname,email,phoneno,password,gname,address,token,date) VALUES('$oname','$email','$phoneno','$password','$gname','$address','$token',  NOW())";
...
try {
    ...
    //Recipients
    $mail->setFrom('bharatkumavat234@gmail.com', 'Resq');
...
<head>
  ...
  display: table-cell;
  width: auto;
  background: url(img/login_signup/18.jpg);
...
<body data-spy="scroll" data-target=".navbar" data-offset="65" style="background: #f4f4f4;">
	...
	<section id="register">
		<div class="register-photo">
			<h2 class="text-center" style="margin-top:-40px;margin-bottom: 20px;"><strong>Garage Registartion.</strong></h2>
        <div class="form-container">
            <div class="image-holder"></div>
            <form method="post">
                <h2 class="text-center"><strong>Create</strong> an account.</h2>
                <div class="form-group"><input class="form-control" type="text" name="oname" placeholder="Enter Owner's Name" required="required"></div>
              ...
              <div class="form-group"><input class="form-control" type="text" name="gname" placeholder="Enter Garage Name" required="required"></div>
              <div class="form-group"><input class="form-control" type="text" name="address" placeholder="Enter Address Of Garage" required="required"></div>
